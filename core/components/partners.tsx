...
const STRATEGIC_PARTNERS: PartnerItem[] = [
  {
  ...
  {
    name: "Universal Energy Resources Limited",
    logo: "/images/md.jpg",
  },
  {
  ...
  {
    name: "Nigerian Nuclear Regulatory Authority",
    logo: "/images/md.jpg",
  },
  {
...
const TOP_PARTNERS: PartnerItem[] = [
  {
    name: "Federal Ministry of Environment",
    logo: "/images/partners/env.jpg",
    description: "Strategic joint venture partnership supporting Nigeria's national oil infrastructure and production goals across multiple operational areas.",
  },
  {
    name: "NUPRC",
    logo: "/images/partners/nuprc.jpg",
    description: "Regulatory partnership ensuring full compliance and responsible operation within Nigeria's upstream petroleum sector framework.",
  },
  {
    name: "Oando PLC",
    logo: "/images/partners/oando.jpg",
    description: "NEPN operates as a Joint Venture with Oando. The partnership combines expertise and resources to support sustainable exploration, production, operations...",
  },
];

const JV_PARTNERS: PartnerItem[] = [
  {
    name: "Oando PLC",
    logo: "/images/partners/oando.jpg",
    description: "NEPN operates as a Joint Venture with Oando. The partnership combines expertise and resources to support sustainable exploration, production, operational excellence, and long-term growth in Nigeria's upstream energy sector.",
  },
];
...
export default function Partners() {
  ...
  const [activeTab, setActiveTab] = useState<"strategic" | "top" | "jv">("strategic");
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      if (tabHeader?.length) {
        animateReveal(tabHeader, rootRef.current?.querySelector("[data-tab-trigger]"));
      }

      if (gridItems?.length) {
        animateReveal(gridItems, rootRef.current?.querySelector("[data-tab-trigger]"), { delay: 0.2 });
      }
  ...
  // Determine current active cards list
    ...
    >
      ...
      >
        <div className="mx-auto max-w-[980px] px-5">
          ...
          >
            Building Partnerships for <span className="italic text-[#14874f]">Nigeria&apos;s Energy Future</span>
          </h2>
          ...
          >
            At NEPN, we recognize that sustainable success is built on strong partnerships. We collaborate with industry leaders, government agencies, and local communities to deliver excellence across all our operations.
          </p>
        </div>
      </section>

      {/* Interactive Tabs Partners Section */}
      <section data-tab-trigger className="bg-[#ededed] py-16 sm:py-20 border-t border-neutral-200/50">
        <div className="mx-auto max-w-[980px] px-5">
          ...
          <div className="mb-10 border-b border-neutral-200/60 flex flex-wrap justify-center sm:justify-start gap-x-8 gap-y-4">
            <button
              ...
              className={`pb-3 font-bold text-[10px] sm:text-xs tracking-[0.15em] transition-all relative uppercase cursor-pointer ${activeTab === "strategic"
                  ? "text-[#168241]"
            ...
            <button
              ...
              className={`pb-3 font-bold text-[10px] sm:text-xs tracking-[0.15em] transition-all relative uppercase cursor-pointer ${activeTab === "top"
                  ? "text-[#168241]"
                  : "text-neutral-400 hover:text-neutral-600"
                }`}
              style={{ fontFamily: "'Barlow Condensed', sans-serif" }}
            ...
            <button
              ...
              className={`pb-3 font-bold text-[10px] sm:text-xs tracking-[0.15em] transition-all relative uppercase cursor-pointer ${activeTab === "jv"
                  ? "text-[#168241]"
                  : "text-neutral-400 hover:text-neutral-600"
                }`}
              style={{ fontFamily: "'Barlow Condensed', sans-serif" }}
          ...
          <div
            data-grid-items
            className={`grid gap-5 ${activeTab === "strategic"
            ...
            {currentPartners.map((partner) => (
              ...
              >
                <div className="w-full flex-1 flex flex-col justify-center items-center">
                  ...
                  <h3
                    className="text-sm font-bold text-[#1e2620] mt-5 leading-snug px-3 max-w-[240px]"
                    style={{ fontFamily: "'Poppins', sans-serif" }}
                  >
                    {partner.name}
                  </h3>
                  ...
                  {partner.description && (
                    <p
                      className="mt-4 text-xs sm:text-[13px] text-neutral-500 leading-relaxed font-sans px-2 max-w-[340px]"
                      style={{ fontFamily: "'Poppins', sans-serif" }}
                    >
                      {partner.description}
                    </p>
      ...
      <section className="bg-[#1b1cff] relative overflow-hidden py-16 sm:py-20">
        ...
        <div className="mx-auto max-w-[980px] px-5 relative z-10 text-center flex flex-col items-center">
          ...
          <p
            className="text-white/80 text-sm sm:text-base leading-relaxed max-w-2xl font-sans mb-10"
            style={{ fontFamily: "'Poppins', sans-serif" }}
          >
            We are always open to strategic alliances with organizations that share our vision for responsible energy development in Nigeria.
          </p>
      ...
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Barlow:wght@400;500;600;700&family=Barlow+Condensed:wght@600;700;800;900&family=DM+Sans:wght@700&family=Poppins:wght@400;600;700&display=swap');
      `}</style>
    </div>
  );
}
