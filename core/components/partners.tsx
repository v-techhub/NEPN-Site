                    ...
                    >
                        {isLoading ? (
                            Array.from({ length: 3 }).map((_, i) => (
                                <div key={i} className="bg-white rounded-2xl p-8 border border-neutral-100/90 flex flex-col justify-center items-center h-48 animate-pulse">
                            ...
                            <div className="col-span-full py-16 flex flex-col items-center justify-center text-center">
                                <p className="text-neutral-400 font-medium text-sm">No partners found.</p>
                            </div>
                        ) : (
