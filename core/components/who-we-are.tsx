...
export default function WhoWeAre() {
  ...
  const [selectedLeader, setSelectedLeader] = useState<LeaderMember | null>(
    null,
  );

  const parseCmsLeaders = (response: typeof cmsLeaders) => {
    if (
      !response ||
      !Array.isArray(response.leadership) ||
      response.leadership.length === 0
    )
      return null;

    return response.leadership.map((item, idx) => {
  ...
  const currentLeaders =
    activeTab === "management" ? activeManagement : activeBoard;
          ...
          <div className="px-5 py-12 sm:px-8 sm:py-16 md:px-10 lg:px-12 bg-white/40 border-t border-b border-neutral-200/50">
            <div className="mx-auto max-w-[980px]">
              <div className="text-center mb-10 sm:mb-12">
                ...
                <p className="mt-3 text-sm sm:text-base text-[#4a5550] max-w-lg mx-auto leading-relaxed">
                    ...
                    >
                      ...
                      <div className="flex flex-col justify-between flex-1 px-[20px] pb-[20px] pt-[18px]">
                        <div>
                          ...
                          <p className="mt-3 text-neutral-600 text-[13px] leading-[1.6]">
                            {member.body}
                          </p>
                        </div>
          ...
          <div className="flex w-full justify-center">
            <div className="flex w-full max-w-[1184px] flex-col gap-6 py-8 md:h-[56.666668px] md:flex-row md:items-center md:justify-between md:gap-8 md:py-0">
              <div data-cta-part className="w-full max-w-[408.072937px]">
                ...
                <p
                  className="mt-[6px] max-w-[408px] font-sans"
                  style={{
